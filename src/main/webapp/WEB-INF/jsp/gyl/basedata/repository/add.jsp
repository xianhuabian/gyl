...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/images/title_arrow.gif"/> 仓库信息
        </div>
...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="repositoryAction_add.action">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr><td>区域</td>
                        <td><s:textarea name="area" cssClass="InputStyle"></s:textarea></td>
                    </tr>
                    <tr><td>地址</td>
