...
<script type="text/javascript">
	$(document).ready(function(){
		$("body").data("url","cgddAction_showCgdd.action?query_zhib.cgddzhubid=");
		//点击主表中的某一行加载子表
...
<body>
<table id="wrap">
	<s:form action="cgddAction_showCgdd.action">
	<tr>
    	<td id="rig_top" >
	...
	<tr>
    	<td id="rig_top" >
            ...
            <table cellspacing="0" cellpadding="0" id="maintain-top" align="center"  width="2000"  style="font-size:12px;">
                ...
                <tr field="item_zhub" id="${cgddzhubid}">
    	...
    	<td id="right_center" >
            ...
            <table cellspacing="0" cellpadding="0"  id="maintain-right"  style="font-size:12px;">
                ...
                <s:iterator value="#pageResult_zhib.rows" status="st1">
               	<tr class="other" field="item_zhib" id="${cgddzhub.cgddzhubid}">
