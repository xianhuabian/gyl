...
<script type="text/javascript">
	$(document).ready(function(){
		$("body").data("url","cgrkdAction_showCgrkd.action?query_zhib.cgrkdzhubid=");
		//点击主表中的某一行加载子表
...
<body>
<table id="wrap">
	<s:form action="cgrkdAction_showCgrkd.action">
	<tr>
    	<td id="rig_top" >
            ...
            <table class="content" style="font-size:12px;" align="center">
            	<tr>
                    ...
                    <td class="inp"><input type="text"  style="background:url(images/search.png) no-repeat 226px center #F6F9FD;" name="query_zhu.djh"/></td>
                </tr>
               <!--  <tr>
                    <td class="one" style="color:#00F;">单据号</td>
	...
	<tr>
    	<td id="rig_top" >
            ...
            <table cellspacing="0" cellpadding="0" id="maintain-top" align="center"  width="2000"  style="font-size:12px;">
                ...
                <tr field="item_zhub" id="${cgrkdzhubid}">
    	...
    	<td id="right_center" >
            ...
            <table cellspacing="0" cellpadding="0"  id="maintain-right"  style="font-size:12px;">
                ...
                <s:iterator value="#pageResult_zhib.rows" status="st1">
               	<tr class="other" field="item_zhib" id="${cgrkdzhub.cgrkdzhubid}">
