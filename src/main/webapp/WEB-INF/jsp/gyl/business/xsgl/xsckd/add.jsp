...
<body>
<s:form action="xsckdAction_add.action">
<table id="wrap">
	<tr>
    	<td id="rig_top" >
    ...
    <tr>
    	<td id="right_center" >
            ...
            <table cellspacing="0" cellpadding="0"  id="maintain-right"  style="font-size:12px;" width="5000">
                ...
                <tr align="center">
                    <td style="width:30px; text-align:center; background:#E2E2E2;" item='hh'><input type="text" style="width:100%;" readonly="true" name="xsckdzhibs[0].hh" value="1"/></td>
                    <td class="inp" item="spmc">
                    	<div class="inp_search">
                    		<input type="text" class="bdnone" readonly="readonly" name="xsckdzhibs[0].spmc"/>
                    ...
                    <td style="border-collapse:collapse;  empty-cells:show;" item="spbm"><input readonly="readonly" type="text" style="width:100%;" name="xsckdzhibs[0].xh"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;" item="xh"><input readonly="readonly" type="text" style="width:100%;" name="xsckdzhibs[0].dw"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;" item="dw"><input type="text" style="width:100%;" name="xsckdzhibs[0].sl"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;" item="sl"><input readonly="readonly" type="text" style="width:100%;" name="xsckdzhibs[0].shulv"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;" item="dj"><input type="text" style="width:100%;" name="xsckdzhibs[0].dpkl"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;" item="je"><input type="text" style="width:100%;" name="xsckdzhibs[0].wsdj"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;" item="yfsl"><input type="text" style="width:100%;" readonly="true" name="xsckdzhibs[0].hsdj"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;" item="sfsl"><input type="text" style="width:100%;" name="xsckdzhibs[0].wsje"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;" item="ytdjh"><input type="text" style="width:100%;" readonly="true" name="xsckdzhibs[0].hsje"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;" item="ythh"><input type="text" style="width:100%;" readonly="true" name="xsckdzhibs[0].se"/></td>
                    <td style="border-collapse:collapse;  empty-cells:show;" item="ljfhsl"><input type="text" style="width:100%;" readonly="true" name="xsckdzhibs[0].zke"/></td>
                </tr>
            </table>
           </div>
    	</td>
