    	...
    	<td id="right_center" >
            ...
            <table cellspacing="0" cellpadding="0"  id="maintain-right"  style="font-size:12px;" width="5000">
                ...
                <tr align="center">
                    ...
                    <td style="border-collapse:collapse;  empty-cells:show;" item="fhck"><input type="text" style="width:100%;" />
                    	<s:select 
                        		list="#repositories" 
                        		listKey="name" 
                        		listValue="name" 
                        		cssClass="SelectStyle" 
                        		name="xsddzhibs[0].fhck">
                        </s:select>
